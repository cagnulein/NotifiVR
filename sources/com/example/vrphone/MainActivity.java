...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        imageView.setImageIcon(Icon.createWithResource(this, R.drawable.ic_action_name));
                        ...
                        if (!socket.isConnected()) {
                            MainActivity.this.runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    edit.putBoolean("running", false);
                                    edit.commit();
                                    MainActivity.iView.setVisibility(0);
                                    MainActivity.pBar.setVisibility(4);
                                    MainActivity.iView2.setVisibility(4);
                                }
                            });
                            return;
                        }
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.item1:
                ...
                return true;
            case R.id.item2:
                startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://discord.gg/nBpH9Q")));
                return true;
            case R.id.item3:
                startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://paypal.me/pools/c/8rs3akFENP")));
                return true;
            default:
                return false;
        }
